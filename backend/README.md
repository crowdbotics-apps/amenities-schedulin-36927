...
## Project Structure
    ...
    ├── amenities_schedulin_36927  # Django project configurations
...
1. Clone this repo and `cd amenities_schedulin_36927`
...
2. Clone this repo and `cd amenities_schedulin_36927`
